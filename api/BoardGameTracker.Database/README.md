...
```bash
./SqlPackage /Action:Publish /SourceFile:bin/Debug/BoardGameTracker.Database.dacpac /TargetServerName:localhost /TargetDatabaseName:BoardGameTracker.Database
```
